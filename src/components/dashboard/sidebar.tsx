    ...
    <>
      ...
      >
        <div className="px-5 py-4 flex flex-col gap-1">
          {isCollapsed ? (
            <span className="font-bold text-lg text-indigo-600 text-center hidden md:block">T</span>
          ) : (
            <>
              <span className="font-bold text-lg tracking-tight text-indigo-600">TeamPulse</span>
